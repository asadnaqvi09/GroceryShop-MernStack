      ...
      <div className="totalDiv">
        <div className="w-full md:w-64 max-w-md bg-white border border-gray-300 rounded-lg shadow-md">
          ...
          <div className="totalContent p-4 mb-2 gap-2 flex flex-col">
            ...
            {
              cartItems.length > 0 ? (
                <div className="btn-primary rounded-md w-full text-white mt-2 text-center cursor-pointer">
                  {" "}
                  <NavLink to="/checkout"> Proceed to Checkout </NavLink>{" "}
                </div>
              ) : (
                <div className="btn-primary cursor-not-allowed rounded-md w-full text-white mt-2 text-center">
                  {" "}
                  <NavLink aria-disabled="true" > Proceed to Checkout </NavLink>{" "}
                </div>
              )
            }
          </div>
